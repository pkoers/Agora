...
class AdministratorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create administrator" do
    assert_difference("Administrator.count") do
      post administrators_url, params: { administrator: { trusted: @administrator.trusted, user_id: @administrator.user_id } }
    end
  ...
  test "should update administrator" do
    patch administrator_url(@administrator), params: { administrator: { trusted: @administrator.trusted, user_id: @administrator.user_id } }
