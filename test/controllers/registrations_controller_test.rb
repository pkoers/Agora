...
class RegistrationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create registration" do
    assert_difference("Registration.count") do
      post registrations_url, params: { registration: { email_address: @registration.email_address, registration: @registration.registration } }
    end
  ...
  test "should update registration" do
    patch registration_url(@registration), params: { registration: { email_address: @registration.email_address, registration: @registration.registration } }
