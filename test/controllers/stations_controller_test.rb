...
class StationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create station" do
    assert_difference("Station.count") do
      post stations_url, params: { station: { iata_station_code: @station.iata_station_code } }
    end
  ...
  test "should update station" do
    patch station_url(@station), params: { station: { iata_station_code: @station.iata_station_code } }
